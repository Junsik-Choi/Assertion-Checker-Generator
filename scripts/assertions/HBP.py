...
class HBPPlugin(BaseAssertionPlugin):
    ...
    def generate_sv(self, parsed: Dict[str, Any], context: Dict[str, Any]) -> List[str]:
        ...
        lines.append("(")
        lines.append(f"    logic {base_clk},")
        lines.append(f"    logic {base_rst},")
        lines.append(f"    logic {hsync_signal},")
        lines.append(f"    logic {vsync_signal},")
        lines.append(f"    logic {data_enable_signal}")
        lines.append(");")
        lines.append("")
